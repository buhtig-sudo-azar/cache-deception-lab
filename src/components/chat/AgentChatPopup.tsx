      ...
      {isMinimized && (
        <div className="fixed bottom-24 right-6 z-50 animate-in fade-in zoom-in-95 duration-200">
          <button onClick={handleRestore} className="group relative focus:outline-none">
            ...
            <span className="relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full overflow-hidden border-2 border-background shadow-lg bg-primary text-primary-foreground">
              ...
              <div className="flex flex-col items-center justify-center py-6 px-4 text-center">
                ...
                <div className="w-full max-w-[280px] space-y-1.5">
                  ...
                  {agent.suggestions?.map((s, i) => (
                    <button
                      key={i}
                      onClick={() => useChatStore.getState().sendMessage(s, systemPrompt)}
                      disabled={isLoading}
