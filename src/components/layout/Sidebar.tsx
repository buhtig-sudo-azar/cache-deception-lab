...
import {
  ...
  CheckCircle2, Circle, ChevronDown, RotateCcw,
} from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed md:relative z-40 md:z-auto top-14 md:top-0 left-0 h-[calc(100vh-3.5rem)] md:h-full border-r border-border bg-sidebar transition-all duration-300 flex flex-col w-72',
