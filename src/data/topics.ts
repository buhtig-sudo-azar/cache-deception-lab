...
Веб-кэширование тесно связано с HTTP-протоколом: заголовки Cache-Control, Vary, Age управляют поведением кэша. Load Balancers часто совмещены с кэшем. WAF (Web Application Firewall) может влиять на кэширование. Понимание кэша необходимо для изучения Web Cache Deception и Cache Poisoning.`,
        ...
        diagram: {
          ...
          svgContent: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 320" fill="none">
  <defs>
    <linearGradient id="g1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#3b82f6" stop-opacity="0.2"/><stop offset="100%" stop-color="#3b82f6" stop-opacity="0.05"/></linearGradient>
    <linearGradient id="g2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#f59e0b" stop-opacity="0.2"/><stop offset="100%" stop-color="#f59e0b" stop-opacity="0.05"/></linearGradient>
    <linearGradient id="g3" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#10b981" stop-opacity="0.2"/><stop offset="100%" stop-color="#10b981" stop-opacity="0.05"/></linearGradient>
    <filter id="s1"><feDropShadow dx="0" dy="2" stdDeviation="4" flood-opacity="0.1"/></filter>
  </defs>
  <rect x="30" y="110" width="150" height="100" rx="16" fill="url(#g1)" stroke="#3b82f6" stroke-width="1.5" filter="url(#s1)"/>
  <circle cx="105" cy="140" r="18" fill="#3b82f6" opacity="0.15"/>
  <text x="105" y="145" text-anchor="middle" fill="#3b82f6" font-size="16">💻</text>
  <text x="105" y="175" text-anchor="middle" fill="#3b82f6" font-size="14" font-weight="bold">Клиент</text>
  <text x="105" y="195" text-anchor="middle" fill="#64748b" font-size="10">Браузер</text>
  <rect x="325" y="80" width="150" height="160" rx="16" fill="url(#g2)" stroke="#f59e0b" stroke-width="1.5" filter="url(#s1)"/>
  <circle cx="400" cy="115" r="18" fill="#f59e0b" opacity="0.15"/>
  <text x="400" y="120" text-anchor="middle" fill="#f59e0b" font-size="16">🗄️</text>
  <text x="400" y="155" text-anchor="middle" fill="#f59e0b" font-size="14" font-weight="bold">Кэш</text>
  <text x="400" y="175" text-anchor="middle" fill="#64748b" font-size="10">CDN / Proxy</text>
  <rect x="365" y="195" width="70" height="22" rx="11" fill="#10b981" opacity="0.2"/>
  <text x="400" y="210" text-anchor="middle" fill="#10b981" font-size="9" font-weight="bold">HIT</text>
  <rect x="365" y="220" width="70" height="22" rx="11" fill="#ef4444" opacity="0.2"/>
  <text x="400" y="235" text-anchor="middle" fill="#ef4444" font-size="9" font-weight="bold">MISS</text>
  <rect x="620" y="110" width="150" height="100" rx="16" fill="url(#g3)" stroke="#10b981" stroke-width="1.5" filter="url(#s1)"/>
  <circle cx="695" cy="140" r="18" fill="#10b981" opacity="0.15"/>
  <text x="695" y="145" text-anchor="middle" fill="#10b981" font-size="16">🖥️</text>
  <text x="695" y="175" text-anchor="middle" fill="#10b981" font-size="14" font-weight="bold">Origin</text>
  <text x="695" y="195" text-anchor="middle" fill="#64748b" font-size="10">Сервер-источник</text>
  <rect x="210" y="145" width="90" height="28" rx="14" fill="#64748b" opacity="0.1" stroke="#64748b" stroke-width="1" stroke-dasharray="4,2"/>
  <text x="255" y="164" text-anchor="middle" fill="#64748b" font-size="10" font-weight="600">Запрос</text>
  <rect x="505" y="145" width="90" height="28" rx="14" fill="#64748b" opacity="0.1" stroke="#64748b" stroke-width="1" stroke-dasharray="4,2"/>
  <text x="550" y="164" text-anchor="middle" fill="#64748b" font-size="10" font-weight="600">Проброс</text>
</svg>`,
        },
        practicalExamples: [
          {
...
Неправильные заголовки — корневая причина WCD. Если бы все серверы правильно использовали Cache-Control: no-store для динамического контента, WCD не существовал бы. Cache Keys и Cache Rules опираются на эти заголовки.`,
  ...
  <defs>
    <linearGradient id="hg" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#3b82f6" stop-opacity="0.15"/><stop offset="100%" stop-color="#8b5cf6" stop-opacity="0.05"/></linearGradient>
    <filter id="sh"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-opacity="0.08"/></filter>
  </defs>
  <rect x="220" y="10" width="260" height="45" rx="14" fill="url(#hg)" stroke="#3b82f6" stroke-width="1.5" filter="url(#sh)"/>
  <text x="350" y="38" text-anchor="middle" fill="#3b82f6" font-size="13" font-weight="bold">Получен ответ сервера</text>
  <rect x="210" y="80" width="280" height="45" rx="14" fill="#f59e0b" opacity="0.1" stroke="#f59e0b" stroke-width="1.5" filter="url(#sh)"/>
  <text x="350" y="108" text-anchor="middle" fill="#f59e0b" font-size="12" font-weight="600">Проверка Cache-Control</text>
  <rect x="20" y="165" width="190" height="65" rx="14" fill="#ef4444" opacity="0.08" stroke="#ef4444" stroke-width="1.5" filter="url(#sh)"/>
  <rect x="30" y="175" width="60" height="20" rx="10" fill="#ef4444" opacity="0.2"/>
  <text x="60" y="189" text-anchor="middle" fill="#ef4444" font-size="9" font-weight="bold">no-store</text>
  <text x="115" y="189" text-anchor="middle" fill="#ef4444" font-size="10">Не кэшировать</text>
  <text x="115" y="215" text-anchor="middle" fill="#64748b" font-size="9">Абсолютный запрет</text>
  <rect x="250" y="165" width="200" height="65" rx="14" fill="#f59e0b" opacity="0.08" stroke="#f59e0b" stroke-width="1.5" filter="url(#sh)"/>
  <rect x="260" y="175" width="60" height="20" rx="10" fill="#f59e0b" opacity="0.2"/>
  <text x="290" y="189" text-anchor="middle" fill="#f59e0b" font-size="9" font-weight="bold">no-cache</text>
  <text x="370" y="189" text-anchor="middle" fill="#f59e0b" font-size="10">Проверять каждый раз</text>
  <text x="350" y="215" text-anchor="middle" fill="#64748b" font-size="9">Хранить, но валидировать</text>
  <rect x="490" y="165" width="190" height="65" rx="14" fill="#10b981" opacity="0.08" stroke="#10b981" stroke-width="1.5" filter="url(#sh)"/>
  <rect x="500" y="175" width="70" height="20" rx="10" fill="#10b981" opacity="0.2"/>
  <text x="535" y="189" text-anchor="middle" fill="#10b981" font-size="9" font-weight="bold">max-age=N</text>
  <text x="615" y="189" text-anchor="middle" fill="#10b981" font-size="10">Кэшировать на N сек</text>
  <text x="585" y="215" text-anchor="middle" fill="#64748b" font-size="9">Хранить N секунд</text>
  <rect x="220" y="265" width="260" height="55" rx="14" fill="#64748b" opacity="0.08" stroke="#64748b" stroke-width="1" filter="url(#sh)"/>
  <text x="350" y="288" text-anchor="middle" fill="#64748b" font-size="11" font-weight="600">Нет заголовка?</text>
  <text x="350" y="306" text-anchor="middle" fill="#64748b" font-size="9">Эвристическое кэширование</text>
</svg>`,
        },
        practicalExamples: [
          {
...
Vary-заголовок расширяет ключ. Vary: Cookie добавляет значение Cookie к ключу. Vary: Accept-Encoding создаёт разные записи для gzip/br/none.`,
  ...
  <defs>
    <filter id="ks"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-opacity="0.08"/></filter>
  </defs>
  <rect x="20" y="20" width="260" height="240" rx="16" fill="#3b82f6" opacity="0.05" stroke="#3b82f6" stroke-width="1" stroke-dasharray="6,3"/>
  <text x="150" y="48" text-anchor="middle" fill="#3b82f6" font-size="13" font-weight="bold">HTTP Запрос</text>
  <rect x="40" y="65" width="220" height="32" rx="10" fill="#10b981" opacity="0.12" stroke="#10b981" stroke-width="1" filter="url(#ks)"/>
  <rect x="48" y="72" width="8" height="18" rx="4" fill="#10b981"/>
  <text x="150" y="86" text-anchor="middle" fill="#10b981" font-size="11" font-weight="600">GET /profile HTTP/1.1</text>
  <rect x="40" y="105" width="220" height="32" rx="10" fill="#10b981" opacity="0.12" stroke="#10b981" stroke-width="1" filter="url(#ks)"/>
  <rect x="48" y="112" width="8" height="18" rx="4" fill="#10b981"/>
  <text x="150" y="126" text-anchor="middle" fill="#10b981" font-size="11" font-weight="600">Host: example.com</text>
  <rect x="40" y="150" width="220" height="32" rx="10" fill="#ef4444" opacity="0.12" stroke="#ef4444" stroke-width="1" filter="url(#ks)"/>
  <rect x="48" y="157" width="8" height="18" rx="4" fill="#ef4444"/>
  <text x="150" y="171" text-anchor="middle" fill="#ef4444" font-size="11" font-weight="600">Cookie: session=abc</text>
  <rect x="40" y="195" width="220" height="32" rx="10" fill="#ef4444" opacity="0.12" stroke="#ef4444" stroke-width="1" filter="url(#ks)"/>
  <rect x="48" y="202" width="8" height="18" rx="4" fill="#ef4444"/>
  <text x="150" y="216" text-anchor="middle" fill="#ef4444" font-size="11" font-weight="600">Accept: text/html</text>
  <rect x="350" y="50" width="370" height="170" rx="16" fill="#f59e0b" opacity="0.06" stroke="#f59e0b" stroke-width="1.5" filter="url(#ks)"/>
  <text x="535" y="80" text-anchor="middle" fill="#f59e0b" font-size="14" font-weight="bold">Cache Key</text>
  <rect x="380" y="100" width="310" height="35" rx="10" fill="#1e293b" opacity="0.9"/>
  <text x="535" y="123" text-anchor="middle" fill="#f59e0b" font-size="12" font-family="monospace" font-weight="bold">GET|example.com|/profile</text>
  <rect x="380" y="155" width="150" height="28" rx="10" fill="#10b981" opacity="0.15"/>
  <text x="455" y="174" text-anchor="middle" fill="#10b981" font-size="10" font-weight="600">Метод + Хост + Путь</text>
  <rect x="540" y="155" width="150" height="28" rx="10" fill="#ef4444" opacity="0.15"/>
  <text x="615" y="174" text-anchor="middle" fill="#ef4444" font-size="10" font-weight="600">Cookie НЕ входит!</text>
</svg>`,
        },
        practicalExamples: [
          {
...
Если Cache-Control: no-store, расширение не имеет значения. Но если сервер не отправляет этот заголовок — расширение побеждает.`,
  ...
  <defs><filter id="sef"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-opacity="0.08"/></filter></defs>
  <rect x="20" y="70" width="200" height="80" rx="16" fill="#3b82f6" opacity="0.08" stroke="#3b82f6" stroke-width="1.5" filter="url(#sef)"/>
  <text x="120" y="100" text-anchor="middle" fill="#3b82f6" font-size="12" font-weight="bold">URL: /profile.css</text>
  <text x="120" y="120" text-anchor="middle" fill="#64748b" font-size="10">Проверка расширения</text>
  <rect x="290" y="20" width="180" height="80" rx="16" fill="#10b981" opacity="0.08" stroke="#10b981" stroke-width="1.5" filter="url(#sef)"/>
  <rect x="310" y="32" width="50" height="20" rx="10" fill="#10b981" opacity="0.2"/>
  <text x="335" y="46" text-anchor="middle" fill="#10b981" font-size="9" font-weight="bold">.css</text>
  <text x="380" y="46" text-anchor="middle" fill="#10b981" font-size="10">В списке!</text>
  <text x="380" y="70" text-anchor="middle" fill="#10b981" font-size="12" font-weight="bold">КЭШИРОВАТЬ!</text>
  <text x="380" y="88" text-anchor="middle" fill="#64748b" font-size="9">Статический файл</text>
  <rect x="290" y="140" width="180" height="80" rx="16" fill="#ef4444" opacity="0.08" stroke="#ef4444" stroke-width="1.5" filter="url(#sef)"/>
  <rect x="310" y="152" width="50" height="20" rx="10" fill="#ef4444" opacity="0.2"/>
  <text x="335" y="166" text-anchor="middle" fill="#ef4444" font-size="9" font-weight="bold">.php</text>
  <text x="380" y="166" text-anchor="middle" fill="#ef4444" font-size="10">В списке!</text>
  <text x="380" y="190" text-anchor="middle" fill="#ef4444" font-size="12" font-weight="bold">НЕ кэшировать</text>
  <text x="380" y="208" text-anchor="middle" fill="#64748b" font-size="9">Динамический файл</text>
  <rect x="530" y="65" width="150" height="100" rx="16" fill="#f59e0b" opacity="0.08" stroke="#f59e0b" stroke-width="1.5" filter="url(#sef)"/>
  <text x="605" y="95" text-anchor="middle" fill="#f59e0b" font-size="11" font-weight="bold">Кэш сохраняет</text>
  <text x="605" y="115" text-anchor="middle" fill="#f59e0b" font-size="10">профиль как</text>
  <text x="605" y="135" text-anchor="middle" fill="#f59e0b" font-size="10">статический!</text>
  <rect x="555" y="145" width="100" height="14" rx="7" fill="#ef4444" opacity="0.2"/>
  <text x="605" y="155" text-anchor="middle" fill="#ef4444" font-size="8" font-weight="bold">УЯЗВИМОСТЬ</text>
</svg>`,
        },
        practicalExamples: [
          {
...
Директория имеет более низкий приоритет, чем расширение. Но если нет расширения, правило директории вступает в силу.`,
  ...
  <defs><filter id="sdf"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-opacity="0.08"/></filter></defs>
  <rect x="20" y="40" width="280" height="120" rx="16" fill="#3b82f6" opacity="0.08" stroke="#3b82f6" stroke-width="1.5" filter="url(#sdf)"/>
  <text x="160" y="70" text-anchor="middle" fill="#3b82f6" font-size="12" font-weight="bold">URL: /static/../../profile</text>
  <text x="160" y="95" text-anchor="middle" fill="#64748b" font-size="10">Один URL — две интерпретации</text>
  <rect x="380" y="10" width="290" height="85" rx="16" fill="#10b981" opacity="0.08" stroke="#10b981" stroke-width="1.5" filter="url(#sdf)"/>
  <rect x="395" y="22" width="80" height="20" rx="10" fill="#10b981" opacity="0.2"/>
  <text x="435" y="36" text-anchor="middle" fill="#10b981" font-size="9" font-weight="bold">КЭШ</text>
  <text x="525" y="36" text-anchor="middle" fill="#10b981" font-size="10">/static/*</text>
  <text x="525" y="56" text-anchor="middle" fill="#10b981" font-size="11" font-weight="600">Начинается с /static/</text>
  <text x="525" y="76" text-anchor="middle" fill="#10b981" font-size="10" font-weight="bold">КЭШИРОВАТЬ!</text>
  <rect x="380" y="115" width="290" height="85" rx="16" fill="#ef4444" opacity="0.08" stroke="#ef4444" stroke-width="1.5" filter="url(#sdf)"/>
  <rect x="395" y="127" width="80" height="20" rx="10" fill="#ef4444" opacity="0.2"/>
  <text x="435" y="141" text-anchor="middle" fill="#ef4444" font-size="9" font-weight="bold">СЕРВЕР</text>
  <text x="525" y="141" text-anchor="middle" fill="#ef4444" font-size="10">Нормализация</text>
  <text x="525" y="161" text-anchor="middle" fill="#ef4444" font-size="11" font-weight="600">/static/../../profile</text>
  <text x="525" y="181" text-anchor="middle" fill="#ef4444" font-size="10" font-weight="bold">Динамический профиль!</text>
</svg>`,
        },
        practicalExamples: [
          {
...
Главное отличие: в Deception атакующий получает данные жертвы, а в Poisoning жертва получает вредоносный контент атакующего.`,
  ...
  <defs><filter id="wcf"><feDropShadow dx="0" dy="2" stdDeviation="4" flood-opacity="0.08"/></filter></defs>
  <rect x="10" y="30" width="150" height="90" rx="16" fill="#ef4444" opacity="0.08" stroke="#ef4444" stroke-width="1.5" filter="url(#wcf)"/>
  <rect x="25" y="42" width="30" height="20" rx="10" fill="#ef4444" opacity="0.2"/>
  <text x="40" y="56" text-anchor="middle" fill="#ef4444" font-size="10" font-weight="bold">1</text>
  <text x="85" y="56" text-anchor="middle" fill="#ef4444" font-size="11" font-weight="bold">Атакующий</text>
  <text x="85" y="80" text-anchor="middle" fill="#64748b" font-size="10">/profile.css</text>
  <text x="85" y="98" text-anchor="middle" fill="#64748b" font-size="9">Свои данные</text>
  <rect x="220" y="30" width="150" height="90" rx="16" fill="#f59e0b" opacity="0.08" stroke="#f59e0b" stroke-width="1.5" filter="url(#wcf)"/>
  <rect x="235" y="42" width="30" height="20" rx="10" fill="#f59e0b" opacity="0.2"/>
  <text x="250" y="56" text-anchor="middle" fill="#f59e0b" font-size="10" font-weight="bold">2</text>
  <text x="295" y="56" text-anchor="middle" fill="#f59e0b" font-size="11" font-weight="bold">Кэш: .css</text>
  <text x="295" y="80" text-anchor="middle" fill="#f59e0b" font-size="10" font-weight="bold">КЭШИРОВАТЬ!</text>
  <text x="295" y="98" text-anchor="middle" fill="#64748b" font-size="9">Расширение .css</text>
  <rect x="430" y="30" width="150" height="90" rx="16" fill="#3b82f6" opacity="0.08" stroke="#3b82f6" stroke-width="1.5" filter="url(#wcf)"/>
  <rect x="445" y="42" width="30" height="20" rx="10" fill="#3b82f6" opacity="0.2"/>
  <text x="460" y="56" text-anchor="middle" fill="#3b82f6" font-size="10" font-weight="bold">3</text>
  <text x="505" y="56" text-anchor="middle" fill="#3b82f6" font-size="11" font-weight="bold">Сервер</text>
  <text x="505" y="80" text-anchor="middle" fill="#3b82f6" font-size="10">Игнорирует .css</text>
  <text x="505" y="98" text-anchor="middle" fill="#3b82f6" font-size="9">/profile</text>
  <rect x="640" y="30" width="150" height="90" rx="16" fill="#10b981" opacity="0.08" stroke="#10b981" stroke-width="1.5" filter="url(#wcf)"/>
  <rect x="655" y="42" width="30" height="20" rx="10" fill="#10b981" opacity="0.2"/>
  <text x="670" y="56" text-anchor="middle" fill="#10b981" font-size="10" font-weight="bold">4</text>
  <text x="715" y="56" text-anchor="middle" fill="#10b981" font-size="11" font-weight="bold">Кэш сохраняет</text>
  <text x="715" y="80" text-anchor="middle" fill="#10b981" font-size="10">Профиль как CSS</text>
  <text x="715" y="98" text-anchor="middle" fill="#64748b" font-size="9">В кэше!</text>
  <rect x="280" y="170" width="240" height="90" rx="16" fill="#ef4444" opacity="0.1" stroke="#ef4444" stroke-width="2" filter="url(#wcf)"/>
  <rect x="295" y="182" width="30" height="20" rx="10" fill="#ef4444" opacity="0.2"/>
  <text x="310" y="196" text-anchor="middle" fill="#ef4444" font-size="10" font-weight="bold">5</text>
  <text x="400" y="196" text-anchor="middle" fill="#ef4444" font-size="12" font-weight="bold">Жертва</text>
  <text x="400" y="220" text-anchor="middle" fill="#ef4444" font-size="11">/profile.css</text>
  <text x="400" y="242" text-anchor="middle" fill="#ef4444" font-size="10" font-weight="bold">Профиль атакующего!</text>
</svg>`,
        },
        practicalExamples: [
          {
...
**%3F (?)** — Кэш декодирует, сервер не декодирует. Риск: **средний** — кодированный вопросительный знак может обойти фильтры.`,
        ...
        diagram: {
          ...
          svgContent: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 220" fill="none">
  <defs><filter id="ddf"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-opacity="0.08"/></filter></defs>
  <rect x="20" y="60" width="220" height="60" rx="16" fill="#3b82f6" opacity="0.08" stroke="#3b82f6" stroke-width="1.5" filter="url(#ddf)"/>
  <text x="130" y="85" text-anchor="middle" fill="#3b82f6" font-size="13" font-weight="bold">/profile;.css</text>
  <text x="130" y="105" text-anchor="middle" fill="#64748b" font-size="10">Исходный URL</text>
  <rect x="300" y="20" width="180" height="75" rx="16" fill="#f59e0b" opacity="0.08" stroke="#f59e0b" stroke-width="1.5" filter="url(#ddf)"/>
  <rect x="315" y="32" width="70" height="20" rx="10" fill="#f59e0b" opacity="0.2"/>
  <text x="350" y="46" text-anchor="middle" fill="#f59e0b" font-size="9" font-weight="bold">КЭШ</text>
  <text x="390" y="46" text-anchor="middle" fill="#f59e0b" font-size="10" font-weight="bold">Видит .css</text>
  <text x="390" y="70" text-anchor="middle" fill="#f59e0b" font-size="11" font-weight="bold">КЭШИРОВАТЬ</text>
  <text x="390" y="86" text-anchor="middle" fill="#64748b" font-size="9">Расширение .css</text>
  <rect x="300" y="115" width="180" height="75" rx="16" fill="#ef4444" opacity="0.08" stroke="#ef4444" stroke-width="1.5" filter="url(#ddf)"/>
  <rect x="315" y="127" width="70" height="20" rx="10" fill="#ef4444" opacity="0.2"/>
  <text x="350" y="141" text-anchor="middle" fill="#ef4444" font-size="9" font-weight="bold">СЕРВЕР</text>
  <text x="390" y="141" text-anchor="middle" fill="#ef4444" font-size="10">Игнорирует ;.css</text>
  <text x="390" y="165" text-anchor="middle" fill="#ef4444" font-size="11" font-weight="bold">/profile</text>
  <text x="390" y="181" text-anchor="middle" fill="#64748b" font-size="9">Профиль пользователя</text>
  <rect x="530" y="55" width="150" height="90" rx="16" fill="#ef4444" opacity="0.1" stroke="#ef4444" stroke-width="2" filter="url(#ddf)"/>
  <text x="605" y="85" text-anchor="middle" fill="#ef4444" font-size="13" font-weight="bold">УТЕЧКА!</text>
  <text x="605" y="105" text-anchor="middle" fill="#ef4444" font-size="10">Профиль в кэше</text>
  <text x="605" y="125" text-anchor="middle" fill="#ef4444" font-size="9">Доступен всем</text>
</svg>`,
        },
        practicalExamples: [
          {
...
Это означает: сначала ищи файл, потом директорию, потом перенаправь на index.php. Кэш не знает про try_files и судит только по расширению.`,
        ...
        diagram: {
          ...
          svgContent: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 250" fill="none">
  <defs><filter id="pmf"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-opacity="0.08"/></filter></defs>
  <rect x="230" y="10" width="240" height="45" rx="14" fill="#3b82f6" opacity="0.08" stroke="#3b82f6" stroke-width="1.5" filter="url(#pmf)"/>
  <text x="350" y="38" text-anchor="middle" fill="#3b82f6" font-size="13" font-weight="bold">/profile.css</text>
  <rect x="20" y="85" width="260" height="90" rx="16" fill="#f59e0b" opacity="0.08" stroke="#f59e0b" stroke-width="1.5" filter="url(#pmf)"/>
  <rect x="35" y="97" width="70" height="20" rx="10" fill="#f59e0b" opacity="0.2"/>
  <text x="70" y="111" text-anchor="middle" fill="#f59e0b" font-size="9" font-weight="bold">КЭШ</text>
  <text x="150" y="111" text-anchor="middle" fill="#f59e0b" font-size="11" font-weight="bold">.css = статический</text>
  <text x="150" y="135" text-anchor="middle" fill="#f59e0b" font-size="10">Ключ: /profile.css</text>
  <rect x="140" y="145" width="90" height="20" rx="10" fill="#10b981" opacity="0.2"/>
  <text x="185" y="159" text-anchor="middle" fill="#10b981" font-size="9" font-weight="bold">КЭШИРОВАТЬ</text>
  <rect x="420" y="85" width="260" height="90" rx="16" fill="#3b82f6" opacity="0.08" stroke="#3b82f6" stroke-width="1.5" filter="url(#pmf)"/>
  <rect x="435" y="97" width="70" height="20" rx="10" fill="#3b82f6" opacity="0.2"/>
  <text x="470" y="111" text-anchor="middle" fill="#3b82f6" font-size="9" font-weight="bold">СЕРВЕР</text>
  <text x="550" y="111" text-anchor="middle" fill="#3b82f6" font-size="11" font-weight="bold">try_files</text>
  <text x="550" y="135" text-anchor="middle" fill="#3b82f6" font-size="10">profile.css? Нет файла</text>
  <rect x="460" y="145" width="100" height="20" rx="10" fill="#ef4444" opacity="0.2"/>
  <text x="510" y="159" text-anchor="middle" fill="#ef4444" font-size="9" font-weight="bold">Fallback /profile</text>
  <rect x="230" y="200" width="240" height="45" rx="14" fill="#ef4444" opacity="0.1" stroke="#ef4444" stroke-width="2" filter="url(#pmf)"/>
  <text x="350" y="228" text-anchor="middle" fill="#ef4444" font-size="12" font-weight="bold">Профиль в кэше!</text>
</svg>`,
        },
        practicalExamples: [
          {
...
**/a//b** — Кэш различает двойные слеши, сервер схлопывает в /a/b. Риск: **низкий** — большинство современных серверов нормализуют //.`,
        ...
        diagram: {
          ...
          svgContent: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 220" fill="none">
  <defs><filter id="nmf"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-opacity="0.08"/></filter></defs>
  <rect x="20" y="65" width="240" height="60" rx="16" fill="#3b82f6" opacity="0.08" stroke="#3b82f6" stroke-width="1.5" filter="url(#nmf)"/>
  <text x="140" y="90" text-anchor="middle" fill="#3b82f6" font-size="12" font-weight="bold">/static/..%2Fprofile</text>
  <text x="140" y="110" text-anchor="middle" fill="#64748b" font-size="10">Исходный URL</text>
  <rect x="310" y="15" width="200" height="80" rx="16" fill="#f59e0b" opacity="0.08" stroke="#f59e0b" stroke-width="1.5" filter="url(#nmf)"/>
  <rect x="325" y="27" width="70" height="20" rx="10" fill="#f59e0b" opacity="0.2"/>
  <text x="360" y="41" text-anchor="middle" fill="#f59e0b" font-size="9" font-weight="bold">КЭШ</text>
  <text x="410" y="41" text-anchor="middle" fill="#f59e0b" font-size="10">/static/*</text>
  <text x="410" y="61" text-anchor="middle" fill="#f59e0b" font-size="10" font-weight="600">Не нормализует %2F</text>
  <rect x="345" y="70" width="100" height="18" rx="9" fill="#10b981" opacity="0.2"/>
  <text x="395" y="83" text-anchor="middle" fill="#10b981" font-size="9" font-weight="bold">КЭШИРОВАТЬ</text>
  <rect x="310" y="115" width="200" height="80" rx="16" fill="#ef4444" opacity="0.08" stroke="#ef4444" stroke-width="1.5" filter="url(#nmf)"/>
  <rect x="325" y="127" width="70" height="20" rx="10" fill="#ef4444" opacity="0.2"/>
  <text x="360" y="141" text-anchor="middle" fill="#ef4444" font-size="9" font-weight="bold">СЕРВЕР</text>
  <text x="410" y="141" text-anchor="middle" fill="#ef4444" font-size="10">Декодирует %2F</text>
  <text x="410" y="161" text-anchor="middle" fill="#ef4444" font-size="10" font-weight="600">/static/../profile</text>
  <rect x="345" y="168" width="100" height="18" rx="9" fill="#ef4444" opacity="0.2"/>
  <text x="395" y="181" text-anchor="middle" fill="#ef4444" font-size="9" font-weight="bold">/profile</text>
  <rect x="555" y="65" width="125" height="80" rx="16" fill="#ef4444" opacity="0.1" stroke="#ef4444" stroke-width="2" filter="url(#nmf)"/>
  <text x="617" y="95" text-anchor="middle" fill="#ef4444" font-size="12" font-weight="bold">УТЕЧКА!</text>
  <text x="617" y="115" text-anchor="middle" fill="#ef4444" font-size="9">Профиль</text>
  <text x="617" y="130" text-anchor="middle" fill="#ef4444" font-size="9">в кэше</text>
</svg>`,
        },
        practicalExamples: [
          {
...
**Varnish** — полный контроль через VCL. Администратор сам определяет, какие расширения кэшировать. Самый гибкий, но и самый сложный подход.`,
  ...
  <defs><filter id="fnf"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-opacity="0.08"/></filter></defs>
  <rect x="20" y="50" width="220" height="60" rx="16" fill="#3b82f6" opacity="0.08" stroke="#3b82f6" stroke-width="1.5" filter="url(#fnf)"/>
  <text x="130" y="78" text-anchor="middle" fill="#3b82f6" font-size="13" font-weight="bold">profile.css.php</text>
  <text x="130" y="98" text-anchor="middle" fill="#64748b" font-size="10">Двойное расширение</text>
  <rect x="290" y="10" width="180" height="65" rx="16" fill="#10b981" opacity="0.08" stroke="#10b981" stroke-width="1.5" filter="url(#fnf)"/>
  <rect x="305" y="22" width="70" height="20" rx="10" fill="#10b981" opacity="0.2"/>
  <text x="340" y="36" text-anchor="middle" fill="#10b981" font-size="9" font-weight="bold">Nginx</text>
  <text x="380" y="36" text-anchor="middle" fill="#10b981" font-size="10">.css</text>
  <text x="380" y="56" text-anchor="middle" fill="#10b981" font-size="10" font-weight="600">Первое расширение</text>
  <rect x="305" y="48" width="70" height="18" rx="9" fill="#10b981" opacity="0.2"/>
  <text x="340" y="60" text-anchor="middle" fill="#10b981" font-size="8" font-weight="bold">КЭШИРОВАТЬ</text>
  <rect x="290" y="95" width="180" height="65" rx="16" fill="#ef4444" opacity="0.08" stroke="#ef4444" stroke-width="1.5" filter="url(#fnf)"/>
  <rect x="305" y="107" width="70" height="20" rx="10" fill="#ef4444" opacity="0.2"/>
  <text x="340" y="121" text-anchor="middle" fill="#ef4444" font-size="9" font-weight="bold">CF</text>
  <text x="380" y="121" text-anchor="middle" fill="#ef4444" font-size="10">.php</text>
  <text x="380" y="141" text-anchor="middle" fill="#ef4444" font-size="10" font-weight="600">Последнее расширение</text>
  <rect x="305" y="133" width="70" height="18" rx="9" fill="#ef4444" opacity="0.2"/>
  <text x="340" y="145" text-anchor="middle" fill="#ef4444" font-size="8" font-weight="bold">ПРОПУСК</text>
  <rect x="520" y="40" width="160" height="80" rx="16" fill="#f59e0b" opacity="0.08" stroke="#f59e0b" stroke-width="1.5" filter="url(#fnf)"/>
  <text x="600" y="68" text-anchor="middle" fill="#f59e0b" font-size="11" font-weight="bold">Результат зависит</text>
  <text x="600" y="88" text-anchor="middle" fill="#f59e0b" font-size="11" font-weight="bold">от кэша!</text>
  <text x="600" y="108" text-anchor="middle" fill="#64748b" font-size="9">Нет единого стандарта</text>
</svg>`,
        },
        practicalExamples: [
          {
...
**Мониторинг** — Отслеживание X-Cache: HIT на API-эндпоинтах. Если динамический контент кэшируется — это инцидент.`,
  ...
  <defs>
    <filter id="df1"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-opacity="0.08"/></filter>
    <linearGradient id="d1" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#10b981" stop-opacity="0.15"/><stop offset="100%" stop-color="#10b981" stop-opacity="0.03"/></linearGradient>
    <linearGradient id="d2" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#3b82f6" stop-opacity="0.15"/><stop offset="100%" stop-color="#3b82f6" stop-opacity="0.03"/></linearGradient>
    <linearGradient id="d3" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#f59e0b" stop-opacity="0.15"/><stop offset="100%" stop-color="#f59e0b" stop-opacity="0.03"/></linearGradient>
    <linearGradient id="d4" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#8b5cf6" stop-opacity="0.15"/><stop offset="100%" stop-color="#8b5cf6" stop-opacity="0.03"/></linearGradient>
    <linearGradient id="d5" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#ef4444" stop-opacity="0.15"/><stop offset="100%" stop-color="#ef4444" stop-opacity="0.03"/></linearGradient>
  </defs>
  <rect x="80" y="8" width="540" height="48" rx="14" fill="url(#d1)" stroke="#10b981" stroke-width="1.5" filter="url(#df1)"/>
  <rect x="92" y="18" width="28" height="28" rx="14" fill="#10b981" opacity="0.2"/>
  <text x="106" y="37" text-anchor="middle" fill="#10b981" font-size="12" font-weight="bold">1</text>
  <text x="350" y="30" text-anchor="middle" fill="#10b981" font-size="12" font-weight="bold">Cache-Control: no-store, private</text>
  <text x="350" y="46" text-anchor="middle" fill="#64748b" font-size="9">Запрет кэширования динамического контента</text>
  <rect x="80" y="68" width="540" height="48" rx="14" fill="url(#d2)" stroke="#3b82f6" stroke-width="1.5" filter="url(#df1)"/>
  <rect x="92" y="78" width="28" height="28" rx="14" fill="#3b82f6" opacity="0.2"/>
  <text x="106" y="97" text-anchor="middle" fill="#3b82f6" font-size="12" font-weight="bold">2</text>
  <text x="350" y="90" text-anchor="middle" fill="#3b82f6" font-size="12" font-weight="bold">Vary: Cookie + Authorization</text>
  <text x="350" y="106" text-anchor="middle" fill="#64748b" font-size="9">Разные сессии = разные записи кэша</text>
  <rect x="80" y="128" width="540" height="48" rx="14" fill="url(#d3)" stroke="#f59e0b" stroke-width="1.5" filter="url(#df1)"/>
  <rect x="92" y="138" width="28" height="28" rx="14" fill="#f59e0b" opacity="0.2"/>
  <text x="106" y="157" text-anchor="middle" fill="#f59e0b" font-size="12" font-weight="bold">3</text>
  <text x="350" y="150" text-anchor="middle" fill="#f59e0b" font-size="12" font-weight="bold">Нормализация ключей кэша</text>
  <text x="350" y="166" text-anchor="middle" fill="#64748b" font-size="9">Декодирование %2F, удаление ../, схлопывание //</text>
  <rect x="80" y="188" width="540" height="48" rx="14" fill="url(#d4)" stroke="#8b5cf6" stroke-width="1.5" filter="url(#df1)"/>
  <rect x="92" y="198" width="28" height="28" rx="14" fill="#8b5cf6" opacity="0.2"/>
  <text x="106" y="217" text-anchor="middle" fill="#8b5cf6" font-size="12" font-weight="bold">4</text>
  <text x="350" y="210" text-anchor="middle" fill="#8b5cf6" font-size="12" font-weight="bold">Разделение доменов</text>
  <text x="350" y="226" text-anchor="middle" fill="#64748b" font-size="9">api.site.com и static.site.com — изолированные кэши</text>
  <rect x="80" y="248" width="540" height="42" rx="14" fill="url(#d5)" stroke="#ef4444" stroke-width="1" filter="url(#df1)"/>
  <rect x="92" y="256" width="28" height="26" rx="14" fill="#ef4444" opacity="0.2"/>
  <text x="106" y="274" text-anchor="middle" fill="#ef4444" font-size="12" font-weight="bold">5</text>
  <text x="350" y="274" text-anchor="middle" fill="#ef4444" font-size="11" font-weight="bold">Мониторинг X-Cache: HIT на динамических эндпоинтах</text>
</svg>`,
        },
        practicalExamples: [
          {
